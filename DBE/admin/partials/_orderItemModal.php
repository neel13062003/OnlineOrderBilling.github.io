                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        $pizzaPrice1 = $itemrow['pizzaPrice1'];
                                        $pizzaPrice2 = $itemrow['pizzaPrice2'];
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/DBE/img/pizza-'.$pizzaId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$pizzaName. '</h5><span class="text-muted font-weight-normal font-italic d-block">Rs. ' .$pizzaPrice. '/-</span>
                                                        <h5 class="mb-0"> '.$pizzaName. '</h5><span class="text-muted font-weight-normal font-italic d-block">BV = ' .$pizzaPrice1. '</span>
                                                        <h5 class="mb-0"> '.$pizzaName. '</h5><span class="text-muted font-weight-normal font-italic d-block">PV = ' .$pizzaPrice2. '</span>
                                                    </div>
                                                    </div>
                                                </th>
