...
<html lang="en">
  <head>
    ...
    <link rel = "icon" href ="img/1logo.png" type = "image/x-icon">
    <!-- Google Fonts -->
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome  to  <span><b> DPbilling</b>Easy</span> <br>Website</h2>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>DPBillingEasy</strong></h3>
            <h3><strong>The Worldwide DPBilling Problem Solution Here</strong></h3>
            <p class="font-italic">
          </div>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="row" style="text-align:center;">
          ...
          <div class="col-xl-3 col-lg-3 col-md-5" data-wow-delay="0.1s">
            <div class="member">
              <img src="img/neel.jpeg" class="img-fluid" alt="" >
