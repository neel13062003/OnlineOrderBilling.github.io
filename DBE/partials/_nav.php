...
/* '.$systemName.' = lakhi sakay*/
echo '<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:black;max-width:100%;">
      <a class="navbar-brand" href="index.php" style="font-size:1.3rem;margin-top:0px;margin-right:18px;"><b>DPbilling</b>Easy</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="index.php" style="font-size:1.1rem;">Home <span class="sr-only">(current)</span></a>
          </li>
        ...
        <form method="get" action="/DBE/search.php" class="form-inline my-2 my-lg-0 mx-3">
          <input class="form-control mr-sm-2" type="search" name="search" id="search" placeholder="Search Products" aria-label="Search" required>
