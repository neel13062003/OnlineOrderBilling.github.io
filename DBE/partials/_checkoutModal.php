        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
			     <div class="form-group">
                    <b><label for="address">Enter Your Name:</label></b>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="1234 Main Street" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
